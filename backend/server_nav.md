...
<details>
<summary>🗺️ Kliknij tutaj, aby rozwinąć pełną mapę sekcji kodu (0 - 57)</summary>
...
### 🔌 WEBSOCKET SETUP AND HANDLING (6 - 13)
...
* 📍 **56. API: Post-exit sequence** -> `POST /api/exit` - Funkcja wykonująca komendy `taskkill` i reboot skryptów bat.

### 🎭 TERMINAL PROCEDURES (57-58)
